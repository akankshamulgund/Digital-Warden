...
vgg_model = load_model("C:\\Users\\dell\\Downloads\\acmw\\acmw\\Deep-Fake-video-detection-main\\vgg_model.h5")
vgg_model.compile(loss='binary_crossentropy', optimizer='adam', metrics=['accuracy'])

# Load the ResNet50 model
resnet_model = load_model("Deep-Fake-video-detection-main\\resnet_model.h5")
resnet_model.compile(loss='binary_crossentropy', optimizer='adam', metrics=['accuracy'])

# Load the EfficientNet model
effnet_model = load_model("Deep-Fake-video-detection-main\\effnet_model.h5")
